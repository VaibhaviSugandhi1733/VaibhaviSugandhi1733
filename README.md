...
> **Tools:** Terraform · AWS (EC2, S3, DynamoDB, VPC, Security Groups) · Git · AWS CLI

- Designed and provisioned **Dev, Staging & Prod** environments using modular Terraform
- Automated EC2 instances, S3 buckets, DynamoDB tables, Security Groups, and SSH key pair creation
- Managed isolated state files per environment — reduced deployment time **from hours to minutes**

[![View on GitHub](https://img.shields.io/badge/View_on_GitHub-181717?style=flat-square&logo=github&logoColor=white)](https://github.com)

---

### 🔐 Wanderlust: DevSecOps Automated CI/CD Pipeline
> **Tools:** Jenkins · SonarQube · OWASP Dependency-Check · Trivy · Docker · Docker Compose · GitHub

- Built an **end-to-end CI/CD pipeline** with DevSecOps security baked into every stage
- Automated build → test → vulnerability scanning → deployment workflows
- Generated security & quality reports as Jenkins artifacts; deployed via Docker Compose for auditing
